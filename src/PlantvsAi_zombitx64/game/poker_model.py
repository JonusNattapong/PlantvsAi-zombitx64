...
class PokerModel:
    ...
    def evaluate_hand(self, player_cards, ai_cards, community_cards):
        ...
        features = [
            rank_values[player_cards[0]['rank']],
            rank_values[player_cards[1]['rank']],
            rank_values[ai_cards[0]['rank']],
            rank_values[ai_cards[1]['rank']],
            0,  # Placeholder for player_rank
            0   # Placeholder for ai_rank
        ]
